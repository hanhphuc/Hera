 ...
 */
package com.example.anhthunguyen.map_count.preferences;
...
import com.example.anhthunguyen.map_count.Alarm;
import com.example.anhthunguyen.map_count.BaseActivity;
import com.example.anhthunguyen.map_count.R;
import com.example.anhthunguyen.map_count.database.Database;
import com.example.anhthunguyen.map_count.preferences.AlarmPreference.Key;
...
public class AlarmPreferencesActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (bundle != null && bundle.containsKey("adapter")) {
			...
			setListAdapter(new AlarmPreferenceListAdapter(AlarmPreferencesActivity.this, getMathAlarm()));
		}
