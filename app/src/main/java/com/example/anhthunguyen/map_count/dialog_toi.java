...
public class dialog_toi extends Activity {
...
//                                hang.getString("Tenthucan")
                                ...
                                Toast.makeText(dialog_toi.this, calo + "", Toast.LENGTH_LONG).show();
                                Calotoi = calo*unit;
        ...
        spinnermonan.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(dialog_toi.this, tenmonan + "", Toast.LENGTH_SHORT).show();
...
//                                hang.getString("Tenthucan")
        ...
        btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent mhfoodtong = new Intent(dialog_toi.this, food_activity.class);
