...
public class dialog_truanhe extends Activity {
    ...
    public static int Calotruanhe=0;
...
//                                hang.getString("Tenthucan")
                                ...
                                Toast.makeText(dialog_truanhe.this, calo + "", Toast.LENGTH_LONG).show();
                                Calotruanhe = calo*unit;
        ...
        spinnermonan.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(dialog_truanhe.this, tenmonan + "", Toast.LENGTH_SHORT).show();
...
//                                hang.getString("Tenthucan")
        ...
        btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent mhfoodtong = new Intent(dialog_truanhe.this, food_activity.class);
