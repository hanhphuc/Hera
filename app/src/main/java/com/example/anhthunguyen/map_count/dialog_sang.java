...
public class dialog_sang extends Activity {
...
//                                hang.getString("Tenthucan")
                                ...
                                Toast.makeText(dialog_sang.this, calo + "", Toast.LENGTH_LONG).show();
                                Calosang = calo*unit;
        ...
        spinnermonan.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(dialog_sang.this, tenmonan + "", Toast.LENGTH_SHORT).show();
...
//                                hang.getString("Tenthucan")
        ...
        btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent mhfoodtong = new Intent(dialog_sang.this, food_activity.class);
