...
public class dialog_sangnhe extends Activity {
    ...
    public static int Calosangnhe=0;
...
//                                hang.getString("Tenthucan")
                                ...
                                Toast.makeText(dialog_sangnhe.this, calo + "", Toast.LENGTH_LONG).show();
                                Calosangnhe = calo*unit;
        ...
        spinnermonan.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(dialog_sangnhe.this, tenmonan + "", Toast.LENGTH_SHORT).show();
...
//                                hang.getString("Tenthucan")
        ...
        btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent mhfoodtong = new Intent(dialog_sangnhe.this, food_activity.class);
