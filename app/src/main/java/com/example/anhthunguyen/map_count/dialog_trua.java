...
public class dialog_trua extends Activity {
...
//                                hang.getString("Tenthucan")
                                ...
                                Toast.makeText(dialog_trua.this, calo + "", Toast.LENGTH_LONG).show();
                                Calotrua = calo*unit;
        ...
        spinnermonan.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                Toast.makeText(dialog_trua.this, tenmonan + "", Toast.LENGTH_SHORT).show();
...
//                                hang.getString("Tenthucan")
        ...
        btnadd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent mhfoodtong = new Intent(dialog_trua.this, food_activity.class);
